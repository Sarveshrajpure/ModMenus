  ...
  return (
    <div className="dashboardLayoutWrapper">
      ...
      <div className="dashboardLayoutBlock  lg:flex ">
        ...
        >
          <div className="dashBoardTitle flex justify-between align-middle  px-5 py-5 ">
        ...
        <div className="dashboardLayoutRightWrapper lg:w-4/5">
          <div className="dashboardLayoutRightTitle">
            <h1 className="font-bold text-xl px-5 py-5">{props.Title} </h1>
          </div>
